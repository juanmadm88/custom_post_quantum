...
class KyberPKE {
  ...
  factory KyberPKE.customNumberOfPolynomPerVector(int customK) {
    return KyberPKE(
        n: 256, k: customK, q: 3329, eta1: 2, eta2: 2, du: 10, dv: 4
    );
  }

  factory KyberPKE.customModule(int customQ) {
    return KyberPKE(
        n: 256, k: 2, q: customQ, eta1: 3, eta2: 2, du: 10, dv: 4
    );
  }

  factory KyberPKE.customPolynGrade(int customN) {
    return KyberPKE(
        n: customN, k: 2, q: 3329, eta1: 3, eta2: 2, du: 10, dv: 4
    );
  }
